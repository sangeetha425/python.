...
# print(list7.count()) #list.count takes exactly one argument (0 given)
...
list8=[99,88,77,66,55,44,33,22,11]
print(list8.index(66,2,8)) #list8.index(value,start,end)
                           #it starts searching 66 value in between index number 2 to 7
